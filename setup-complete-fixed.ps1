...
Write-Host "Step 1: Creating migration file..." -ForegroundColor Yellow
...
Write-Host ""
Write-Host "Step 3: Creating CSV files..." -ForegroundColor Yellow
...
Write-Host "OK - students.csv created (10 students)" -ForegroundColor Green
...
Write-Host "OK - courses.csv created (11 courses)" -ForegroundColor Green
...
Write-Host "OK - enrollments.csv created (19 enrollments)" -ForegroundColor Green
...
Write-Host "OK - marks.csv created (19 marks with S grades)" -ForegroundColor Green
...
Write-Host "  [OK] migrations/01-add-markscard-schema.sql" -ForegroundColor Green
Write-Host "  [OK] students.csv (10 students)" -ForegroundColor Green
Write-Host "  [OK] courses.csv (11 courses)" -ForegroundColor Green
Write-Host "  [OK] enrollments.csv (19 enrollments)" -ForegroundColor Green
Write-Host "  [OK] marks.csv (19 marks)" -ForegroundColor Green
Write-Host ""
...
Write-Host ""
Write-Host "2. Upload CSV Files (in this order):" -ForegroundColor White
